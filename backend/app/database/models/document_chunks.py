...
from sqlalchemy import Column, Computed, DateTime, ForeignKey, Index, Integer, String, Text, UniqueConstraint, func
...
class DocumentChunk(Base):
    ...
    # Postgres auto-computes this from `text`; GIN index added in migration
