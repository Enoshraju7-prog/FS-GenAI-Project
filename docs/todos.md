...
- [ ] Verify: chunks exist in Supabase; spot-check a known passage
...
- [ ] README "Running locally" section complete
- [ ] Smoke-test all 10 example questions from the client brief
- [ ] Confirm chat history persists across sessions
- [ ] Confirm ~40-user scale (no single-user shortcuts)
- [ ] Basic structured logging (`structlog`) for debugging failed turns
...
- [ ] Supabase: re-enable email confirmation for production
...
| Doc | Purpose |
| --- | ------- |
| [client-brief.md](client-brief.md) | What Driftwood needs and 10 example questions |
| [architecture.md](architecture.md) | System design, data model, streaming contract |
| [guides/supabase-setup.md](guides/supabase-setup.md) | Hosted Postgres + Auth setup |
